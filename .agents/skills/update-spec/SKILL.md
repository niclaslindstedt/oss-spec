...
`.agents/skills/update-spec/.last-updated` contains the git commit hash from the last successful run.
...
| New required agent skill | `src/validate/agent_skills.rs::check`, `templates/_common/.agents/skills/<name>/`, tests |
